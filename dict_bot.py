...
bot = TeleBot(token='6260122441:AAHI67XpEmJzzTxX9feMFyD47wtwNjeHA9s', parse_mode='html') # создание бота
...
DEFINITOINS = {
    ...
    'паттерн': 'шаблон, тенденция проблемы',
    'cпека': 'документ с подробным описанием требований, условий и технических характеристик, как должен работать разрабатываемый функционал',
    'фиксить': 'чинить, исправлять неработающие аспекты приложения, баги',
    'откатить': 'отменить изменения, вернуться к прошлой версии',
    'дебажить': 'исправление ошибок в коде программы',
    'деплой': 'процесс перевода кода в рабочее приложение, чтобы запустить его на компьютере'
 '
}
